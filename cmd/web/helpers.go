...
const maxBytes = 1024 * 1024 // one meg
...
// WriteJson takes a response code and arbitrary data and writes json to the client
...
// ErrorJSON takes an error, and optionally a status code, and generates and send a JSON message
